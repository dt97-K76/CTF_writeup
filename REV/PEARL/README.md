...
```
key = "oF/M5BK_U<rqxCf8zWCPC(RK,/B'v3uARD"
...
for i in range(17):
    var2[2 * i + 1] = int(var6[i] / 5)
    var2[2 * i] = int(var6[i + 17] / 2)

for i in range(34):
    var2[i] += ord(key[33 - i])  
    
for i in range(34):
    var2[i] = var2[i] ^ ord(key[i])
    print(chr(var2[i]), end='')
...
Ở bài này, ta nhận được file .pyc [byteme.pyc](https://github.com/datvn09/CTF_writeup/blob/main/REV/PEARL/byteme.pyc) mã bytecode của python. 
...
```
  ...
  4          22 LOAD_CONST               3 (<code object crackme at 0x55b6afeabeb0, file "byteme.py", line 4>)
             24 MAKE_FUNCTION
             26 STORE_NAME               3 (crackme)

 55          28 LOAD_CONST               4 (<code object solveme at 0x55b6afecd2c0, file "byteme.py", line 55>)
             30 MAKE_FUNCTION
             32 STORE_NAME               4 (solveme)

142          34 LOAD_CONST               5 (<code object breakme at 0x55b6afe64940, file "byteme.py", line 142>)
             36 MAKE_FUNCTION
...
Disassembly of <code object crackme at 0x55b6afeabeb0, file "byteme.py", line 4>:
  4           0 RESUME                   0
...
Disassembly of <code object solveme at 0x55b6afecd2c0, file "byteme.py", line 55>:
  55           0 RESUME                   0
...
Disassembly of <code object breakme at 0x55b6afe64940, file "byteme.py", line 142>:
142           0 RESUME                   0
...
char = itertools.product(characters, repeat = 6)
array = []
...
s.add(answer[6] + answer[7] + answer[8] - answer[5] >= 190)
s.add(answer[6] + answer[5] + answer[5] - answer[2] >= 202)
s.add(answer[9] + answer[3] + answer[2] + answer[5] >= 433)
s.add((answer[7] + answer[0] - answer[0]) + answer[3] >= 237)
s.add((answer[1] - answer[9] - answer[5]) + answer[4] >= -50)
s.add((answer[2] - answer[3]) + answer[1] - answer[1] >= -6)
s.add((answer[8] - answer[7] - answer[6]) + answer[5] >= -88)
s.add(answer[0] + answer[8] - answer[5] - answer[3] >= -117)
s.add(answer[5] + answer[6] + answer[8] + answer[2] >= 385)
s.add((answer[5] - answer[4] - answer[5]) + answer[9] >= 4)
s.add((answer[2] - answer[9]) + answer[5] - answer[0] >= 63)
s.add((answer[2] - answer[5]) + answer[4] - answer[9] >= 13)
s.add(answer[8] + answer[3] + answer[7] - answer[6] >= 167)
s.add(answer[6] - answer[5] - answer[0] - answer[5] >= -126)
s.add(answer[2] - answer[5] - answer[6] - answer[4] >= -199)
